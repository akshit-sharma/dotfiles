...
key_mapper('t', '<A-h>', '<C-\\><C-n><C-w>h', NOREMAP_SILENT)
key_mapper('t', '<A-j>', '<C-\\><C-n><C-w>j', NOREMAP_SILENT)
key_mapper('t', '<A-k>', '<C-\\><C-n><C-w>k', NOREMAP_SILENT)
key_mapper('t', '<A-l>', '<C-\\><C-n><C-w>l', NOREMAP_SILENT)
